package com.sunday.common.jobqueue.executor;
...
public class JobConsumerExecutor {
    ...
    public static interface Contract {
        ...
        /**
         * should insert the given {@link JobHolder} to related . if it already exists, should replace the
         * existing one.
         * @param jobHolder
         */
        ...
        /**
         * should remove the job from the related
         * @param jobHolder
         */
