...
public class Many2ManyAnalyzer extends AssociationsAnalyzer {
	 ...
	 *            {@link org.litepal.LitePalBase#getAssociationInfo(String)}.
	 ...
	 */
	void analyze(DataSupport baseObj, org.litepal.crud.model.AssociationsInfo associationInfo) throws SecurityException,
	...
	/**
	 * This add an empty set for {@link DataSupport#associatedModelsMapForJoinTable}.
	 ...
	 */
	private void declareAssociations(DataSupport baseObj, org.litepal.crud.model.AssociationsInfo associationInfo) {
	 ...
	 * {@link DataSupport#associatedModelsMapForJoinTable} for
	 ...
	 */
	private String getAssociatedTableName(org.litepal.crud.model.AssociationsInfo associationInfo) {
		return org.litepal.util.BaseUtility.changeCase(DBUtility.getTableNameByClassName(associationInfo
	...
	private boolean isDataExists(DataSupport baseObj, DataSupport associatedModel) {
		...
		SQLiteDatabase db = org.litepal.tablemanager.Connector.getDatabase();
		Cursor cursor = null;
		try {
