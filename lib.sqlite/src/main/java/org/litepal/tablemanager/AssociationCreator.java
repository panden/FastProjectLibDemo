...
public abstract class AssociationCreator extends Generator {
	 ...
	 */
	protected String generateCreateTableSQL(String tableName, List<org.litepal.tablemanager.model.ColumnModel> columnModels,
		...
		createTableSQL.append(")");
		org.litepal.util.LogUtil.d(TAG, "create table sql is >> " + createTableSQL);
	 ...
	 */
	protected String generateAddColumnSQL(String tableName, org.litepal.tablemanager.model.ColumnModel columnModel) {
		...
		org.litepal.util.LogUtil.d(TAG, "add column sql is >> " + addColumnSQL);
	...
	protected void giveTableSchemaACopy(String tableName, int tableType, SQLiteDatabase db) {
		...
		org.litepal.util.LogUtil.d(TAG, "giveTableSchemaACopy SQL is >> " + sql);
		Cursor cursor = null;
		try {
	...
	private void createIntermediateTable(String tableName, String associatedTableName,
        ...
        List<org.litepal.tablemanager.model.ColumnModel> columnModelList = new ArrayList<org.litepal.tablemanager.model.ColumnModel>();
        org.litepal.tablemanager.model.ColumnModel column1 = new org.litepal.tablemanager.model.ColumnModel();
        column1.setColumnName(tableName + "_id");
        column1.setColumnType("integer");
        org.litepal.tablemanager.model.ColumnModel column2 = new org.litepal.tablemanager.model.ColumnModel();
		...
		if (DBUtility.isTableExists(tableName, db)) {
			if (DBUtility.isTableExists(associatedTableName, db)) {
				...
				if (!DBUtility.isColumnExists(foreignKeyColumn, tableHoldsForeignKey, db)) {
					...
					org.litepal.util.LogUtil.d(TAG, "column " + foreignKeyColumn
     ...
     */
    private boolean isContainsOnlyIdField(List<org.litepal.tablemanager.model.ColumnModel> columnModels) {
