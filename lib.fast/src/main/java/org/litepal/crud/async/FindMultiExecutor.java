...
public class FindMultiExecutor extends AsyncExecutor {
    ...
    private org.litepal.crud.callback.FindMultiCallback cb;
     ...
     */
    public void listen(org.litepal.crud.callback.FindMultiCallback callback) {
        cb = callback;
        execute();
    }

    public org.litepal.crud.callback.FindMultiCallback getListener() {
        return  cb;
    }
