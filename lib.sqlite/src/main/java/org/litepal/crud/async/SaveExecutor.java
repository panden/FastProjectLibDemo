...
public class SaveExecutor extends AsyncExecutor {
    ...
    private org.litepal.crud.callback.SaveCallback cb;
     ...
     */
    public void listen(org.litepal.crud.callback.SaveCallback callback) {
        cb = callback;
        execute();
    }

    public org.litepal.crud.callback.SaveCallback getListener() {
        return  cb;
    }
