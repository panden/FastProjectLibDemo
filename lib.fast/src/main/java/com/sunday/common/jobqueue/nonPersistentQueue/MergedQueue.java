package com.sunday.common.jobqueue.nonPersistentQueue;


import com.sunday.common.jobqueue.JobHolder;
...
abstract public class MergedQueue implements JobSet {
    ...
    /**
     *
     * @param initialCapacity passed to {@link MergedQueue#createQueue(com.path.android.jobqueue.nonPersistentQueue.MergedQueue.SetId, int, Comparator)}
     * @param comparator passed to {@link MergedQueue#createQueue(com.path.android.jobqueue.nonPersistentQueue.MergedQueue.SetId, int, Comparator)}
