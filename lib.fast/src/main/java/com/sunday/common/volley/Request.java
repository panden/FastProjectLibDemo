...
package com.sunday.common.volley;
...
import com.sunday.common.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public Request(int method, String url, Response.ErrorListener listener) {
        mMethod = method;
        mKey = url;
        if(!TextUtils.isEmpty(Volley.HOST)){
            mUrl = Volley.HOST+url;
        }else{
            mUrl = url;
        }
    ...
    private byte[] encodeParameters(Map<String, String> params, String paramsEncoding) {
        ...
        try {
            ...
            Log.i("HTTP", encodedParams.toString());
            return encodedParams.toString().getBytes(paramsEncoding);
        } catch (Exception uee) {
            Log.e("HTTP", paramsEncoding + "url" + getKey());
            throw new RuntimeException("Encoding not supported: " + paramsEncoding + "url"+getKey(), uee );
        }
    }
    ...
    public void deliverError(VolleyError error) {
        if (mErrorListener != null) {
            mErrorListener.onErrorResponse(getKey(),error);
        }
    }
