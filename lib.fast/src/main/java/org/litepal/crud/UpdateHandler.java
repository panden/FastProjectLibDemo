...
class UpdateHandler extends DataHandler {
	...
	int onUpdateAll(DataSupport baseObj, String... conditions) throws SecurityException,
        ...
        org.litepal.util.BaseUtility.checkConditionsCorrect(conditions);
				...
				if (!isIdColumn(name)) {
                    ...
                    if (isCollection(field.getType())) {
                        if (ids != null && ids.length > 0) {
                            ...
                            if (org.litepal.util.BaseUtility.isGenericTypeSupported(genericTypeName)) {
    ...
    private void updateGenericTables(DataSupport baseObj, List<Field> supportedGenericFields,
        ...
        if (ids != null && ids.length > 0) {
            for (Field field : supportedGenericFields) {
                org.litepal.annotation.Encrypt annotation = field.getAnnotation(org.litepal.annotation.Encrypt.class);
                    ...
                    for (long id : ids) {
                        ...
                        for (Object object : collection) {
                            ...
                            if (baseObj.getClassName().equals(genericTypeName)) {
                                ...
                                Object[] parameters = new Object[] { DBUtility.convertToValidColumnName(org.litepal.util.BaseUtility.changeCase(field.getName())), object };
