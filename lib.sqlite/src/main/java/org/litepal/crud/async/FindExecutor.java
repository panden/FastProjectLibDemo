...
public class FindExecutor extends AsyncExecutor {
    ...
    private org.litepal.crud.callback.FindCallback cb;
     ...
     */
    public void listen(org.litepal.crud.callback.FindCallback callback) {
        cb = callback;
        execute();
    }

    public org.litepal.crud.callback.FindCallback getListener() {
        return  cb;
    }
