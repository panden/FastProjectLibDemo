...
class SaveHandler extends DataHandler {
	...
	/**
	 * Calling {@link android.database.sqlite.SQLiteDatabase#insert(String, String, ContentValues)} to
	...
	/**
	 * Calling
	 * {@link android.database.sqlite.SQLiteDatabase#update(String, ContentValues, String, String[])} to
