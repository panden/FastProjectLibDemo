...
package com.sunday.common.xlog.internal;

import android.content.Intent;
import android.os.Bundle;

import com.sunday.common.xlog.flattener.DefaultFlattener;
import com.sunday.common.xlog.flattener.Flattener;
import com.sunday.common.xlog.formatter.border.BorderFormatter;
import com.sunday.common.xlog.formatter.border.DefaultBorderFormatter;
import com.sunday.common.xlog.formatter.message.json.DefaultJsonFormatter;
import com.sunday.common.xlog.formatter.message.json.JsonFormatter;
import com.sunday.common.xlog.formatter.message.object.BundleFormatter;
import com.sunday.common.xlog.formatter.message.object.IntentFormatter;
import com.sunday.common.xlog.formatter.message.object.ObjectFormatter;
import com.sunday.common.xlog.formatter.message.throwable.DefaultThrowableFormatter;
import com.sunday.common.xlog.formatter.message.throwable.ThrowableFormatter;
import com.sunday.common.xlog.formatter.message.xml.DefaultXmlFormatter;
import com.sunday.common.xlog.formatter.message.xml.XmlFormatter;
import com.sunday.common.xlog.formatter.stacktrace.DefaultStackTraceFormatter;
import com.sunday.common.xlog.formatter.stacktrace.StackTraceFormatter;
import com.sunday.common.xlog.formatter.thread.DefaultThreadFormatter;
import com.sunday.common.xlog.formatter.thread.ThreadFormatter;
import com.sunday.common.xlog.printer.Printer;
import com.sunday.common.xlog.printer.file.FilePrinter;
import com.sunday.common.xlog.printer.file.backup.BackupStrategy;
import com.sunday.common.xlog.printer.file.backup.FileSizeBackupStrategy;
import com.sunday.common.xlog.printer.file.naming.ChangelessFileNameGenerator;
import com.sunday.common.xlog.printer.file.naming.FileNameGenerator;
