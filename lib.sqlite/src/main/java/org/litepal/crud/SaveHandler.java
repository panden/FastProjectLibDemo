...
class SaveHandler extends DataHandler {
	 ...
	 * {@link DataSupport#saveAll(java.util.Collection)}. Each model in the collection
	 ...
	 * {@link #beforeSave(DataSupport, java.util.List, android.content.ContentValues)} will be called to
	 * put the values for ContentValues. When the model is saved,
	 * {@link #afterSave(DataSupport, java.util.List, java.util.List, long)} will be called to do stuffs
