...
public class AverageExecutor extends AsyncExecutor {
    ...
    private org.litepal.crud.callback.AverageCallback cb;
     ...
     */
    public void listen(org.litepal.crud.callback.AverageCallback callback) {
        cb = callback;
        execute();
    }

    public org.litepal.crud.callback.AverageCallback getListener() {
        return  cb;
    }
