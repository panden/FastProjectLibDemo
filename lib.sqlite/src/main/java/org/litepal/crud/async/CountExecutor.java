...
public class CountExecutor extends AsyncExecutor {
    ...
    private org.litepal.crud.callback.CountCallback cb;
     ...
     */
    public void listen(org.litepal.crud.callback.CountCallback callback) {
        cb = callback;
        execute();
    }

    public org.litepal.crud.callback.CountCallback getListener() {
        return  cb;
    }
