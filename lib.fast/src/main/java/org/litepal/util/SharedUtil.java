...
public class SharedUtil {
	...
	public static void updateVersion(String extraKeyName, int newVersion) {
		SharedPreferences.Editor sEditor = org.litepal.LitePalApplication.getContext()
	...
	public static int getLastVersion(String extraKeyName) {
		SharedPreferences sPref = org.litepal.LitePalApplication.getContext().getSharedPreferences(
